...
const libs_freertos_r5f = {
    common: [
        ...
        "mbedtls.am64x.r5f.ti-arm-clang.${ConfigName}.lib",
        "unity.am64x.r5f.ti-arm-clang.${ConfigName}.lib",
        "security.am64x.r5f.ti-arm-clang.${ConfigName}.lib"
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "test_mbedtls";
    property.isInternal = true;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "This is the mbedTLS test suite for SSL and X509"
