...
function enet_cpsw_getPhyaddress(platform, port)
{
    const cpswPhyAddrInfoMap = new Map(
                                           [
                                             ['am275x-evm',{phyAddr1: 15, phyAddr2: 3}],
                                           ],
                                         );
...
function getCpswInstInfo(instance) {
    const cpswInstInfoMap = new Map(
                               [
                                 ['am275x',{enetType: 'ENET_CPSW_3G', numMacPorts: '2', instId: '0', dmaIf:'ENET_SOC_HOSTPORT_DMA_TYPE_UDMA', macPortList:['ENET_MAC_PORT_1', 'ENET_MAC_PORT_2']}],
                               ],
                             );
...
function getBoardConfigTemplateInfo() {
    const boardConfigTemplate = new Map(
                               [
                                 ['am275x',{Cfile: "/networking/enet_cpsw/templates/am275x/enet_board_cfg.c.xdt",
                                  Header: "/networking/enet_cpsw/templates/am275x/enet_board_cfg.h.xdt"}],
                               ],
                             );
...
function getSocConfigTemplateInfo() {
    const socConfigTemplate = new Map(
                               [
                                 ['am275x',{Cfile: "/networking/enet_cpsw/templates/am275x/enet_soc_cfg.c.xdt"}],
                               ],
                             );
	...
	const cpuInfo = new Map(
                               [
                                 ...
                                 ['CSL_CORE_ID_R5FSS1_1',{subsystem: "R5FSS",
                                  clusternum: "1", core: "1"}],
                                 ['CSL_CORE_ID_C75SS0_0',{subsystem: "C75SS",
                                  clusternum: "0", core: "0"}],
