...
const buildOptionCombos = [
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am261x-lp-dp83tg720/am261x-lp-lp", os: "freertos"},
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am261x-lp-dp83826/am261x-lp-lp", os: "freertos"},
];
...
function getComponentProperty() {
    ...
    property.name = "enet_cpsw_loopback_phy_end";
