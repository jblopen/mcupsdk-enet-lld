...
const libs_nortos_r5f = {
    common: [
        ...
        "lwipif-cpsw-nortos.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-nortos.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
        "board.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-contrib-nortos.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const buildOptionCombos = [
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am261x-lp-dp83tg720/am261x-lp", os: "nortos"},
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am261x-lp-dp83826/am261x-lp", os: "nortos"},
];
