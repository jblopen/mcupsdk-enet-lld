...
const libs_freertos_r5f = {
    common: [
        ...
        "enet-cpsw.am62x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwipif-cpsw-freertos.am62x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-freertos.am62x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-contrib-freertos.am62x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_ENET_LWIP_CPSW_UDP_IGMP";
...
function getComponentProperty() {
    ...
    property.name = "enet_cpsw_udp_igmp";
