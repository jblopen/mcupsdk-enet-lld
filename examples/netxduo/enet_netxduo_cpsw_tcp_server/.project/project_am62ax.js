...
const readmeDoxygenPageTag = "EXAMPLES_ECLIPSE_THREADX_NETXDUO_CPSW_TCP_SERVER";
...
function getComponentProperty() {
    ...
    property.name = "enet_netxduo_cpsw_tcp_server";
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "A simple TCP server example for NetxDuo with CPSW."
