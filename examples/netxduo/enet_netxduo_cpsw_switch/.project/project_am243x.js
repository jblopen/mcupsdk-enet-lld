...
const readmeDoxygenPageTag = "EXAMPLES_ECLIPSE_THREADX_NETXDUO_CPSW_SWITCH";
...
function getComponentProperty() {
    ...
    property.name = "enet_netxduo_cpsw_switch";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "A simple example for NetxDuo with CPSW in switch mode."
