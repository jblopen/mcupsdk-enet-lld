...
const readmeDoxygenPageTag = "EXAMPLES_ECLIPSE_THREADX_NETXDUO_ICSSG_SWITCH";
...
function getComponentProperty() {
    ...
    property.name = "enet_netxduo_icssg_switch";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "A simple example for NetxDuo with ICSSG in switch mode."
