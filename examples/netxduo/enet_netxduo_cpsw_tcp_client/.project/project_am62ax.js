...
const readmeDoxygenPageTag = "EXAMPLES_ECLIPSE_THREADX_NETXDUO_CPSW_TCP_CLIENT";
...
function getComponentProperty() {
    ...
    property.name = "enet_netxduo_cpsw_tcp_client";
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "A simple TCP client example for NetxDuo with CPSW."
