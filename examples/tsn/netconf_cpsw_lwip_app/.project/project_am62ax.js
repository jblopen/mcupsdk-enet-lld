...
const libdirs_freertos = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/networking/pugixml_library/lib",
...
const libs_freertos_r5f = {
    common: [
        ...
        "libc.a",
        "libsysbm.a",
        "tsn_combase-freertos.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "tsn_unibase-freertos.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "tsn_gptp-freertos.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "tsn_uniconf-freertos.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "tsn_netconf-freertos.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_CPSW_LWIP_TSN_NETCONF";
...
function getComponentProperty() {
    ...
    property.name = "netconf_cpsw_lwip_app";
